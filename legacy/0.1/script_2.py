...
# Crear aplicación Flutter para análisis de aburrimiento grupal
...
pubspec = '''
name: analizador_aburrimiento
description: Aplicación Flutter para análisis de aburrimiento grupal con ML
...
dependencies:
  ...
  # HTTP client para conexión con backend Python
  http: ^1.1.0
  
  # Para ML on-device (opcional)
  tflite_flutter: ^0.10.0
  
  # Para análisis de sentimientos (opcional)
...
# Guardar archivos Flutter
with open('flutter_main.dart', 'w', encoding='utf-8') as f:
    f.write(flutter_app)

with open('pubspec.yaml', 'w', encoding='utf-8') as f:
    f.write(pubspec)

print("✓ Aplicación Flutter creada exitosamente")
print("\nArchivos generados:")
print("1. flutter_main.dart - Código principal de la aplicación")
print("2. pubspec.yaml - Configuración de dependencias")
print("\nCaracterísticas de la aplicación Flutter:")
print("- Interfaz Material Design 3")
print("- Formulario para ingresar indicadores de aburrimiento")
print("- Análisis en tiempo real con visualización de resultados")
print("- Indicadores categorizados por estructuras teóricas")
print("- Sistema de recomendaciones basado en el nivel detectado")
print("- Compatible con integración a backend Python via HTTP")
